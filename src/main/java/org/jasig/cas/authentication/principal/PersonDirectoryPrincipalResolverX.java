 ...
 *
 */
public class PersonDirectoryPrincipalResolverX implements PrincipalResolver {
    ...
    public Principal resolve(final Credential credential) {
		...
		try {
			...
			attributes = retrievePersonAttributes(principalId);
        ...
        try {
			...
			System.out.println("#### attributes " + objectMapper.writeValueAsString(attributes));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
    ...
    protected Map<String, List<Object>> retrievePersonAttributes(final String principalId) {
        ...
        System.out.println("###### personAttributes " + personAttributes);
        final Map<String, List<Object>> attributes;
